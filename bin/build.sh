...
echo "Updating version to ${VERSION} in wp-hamazon.php and readme.txt"
sed -i.bak "s/\* Version: .*/\* Version: ${VERSION}/g" ./wp-hamazon.php
sed -i.bak "s/^Stable Tag: .*/Stable Tag: ${VERSION}/g" ./readme.txt

# Clean up backup files
rm -f ./wp-hamazon.php.bak ./readme.txt.bak
